...
\newcommand{\projecttitle}{\Huge \bf{Librehatti}\vskip 0.5in}
...
{Submitted To:} \\
\textnormal{Dr K.S Mann\\
Head Of Department\\                                                                                                                          
Information Technology} % Supervisor's Name
\end{flushright}
\end{minipage}\\[2cm]
\HRule \\[0.4cm]
